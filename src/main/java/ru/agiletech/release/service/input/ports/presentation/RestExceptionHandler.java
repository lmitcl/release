...
import ru.agiletech.release.service.infrastructure.persistence.ReleaseNotFoundException;
import ru.agiletech.release.service.infrastructure.persistence.RepositoryAccessException;
...
public class RestExceptionHandler {
    ...
    private ResponseEntity<String> catchNotFoundException(ReleaseNotFoundException ex){
        return new ResponseEntity<>(ex.getMessage(),
